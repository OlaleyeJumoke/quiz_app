...
import 'package:quiz_app/views/results_page.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
     Color bgColor3 = ColorScheme.fromSeed(seedColor: Colors.green).primaryContainer;
  ...
  ElevatedButton buildElevatedButton() {
    //  const Color bgColor3 = Color(0xFF5170FD);
     Color cardColor = ColorScheme.fromSeed(seedColor: Colors.green).primary;
